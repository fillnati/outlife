//Made by Pechyvo
class CraftSpur_MilBag_WoodlandCamo extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Зшити рюкзак";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(1,"AssaultBag_Ttsko");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Spur_MilBag_WoodlandCamo");//add results here
