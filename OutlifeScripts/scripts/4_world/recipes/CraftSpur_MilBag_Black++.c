//Made by Pechyvo
class CraftSpur_MilBag_Black extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Зшити рюкзак";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(1,"AssaultBag_Black");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Spur_MilBag_Black");//add results here
