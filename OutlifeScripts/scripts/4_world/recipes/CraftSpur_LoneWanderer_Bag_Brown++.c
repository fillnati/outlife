//Made by Pechyvo
class CraftSpur_LW_Bag_Brown extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Зшити рюкзак";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(1,"LeatherSack_Brown");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Spur_LW_Bag_Brown");//add results here
