//Made by Pechyvo
class DeCraftBarrel extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Розрізати Бочку";
		...
		//ingredient 2
		InsertIngredient(1,"Barrel_Green");//you can insert multiple ingredients this way
		InsertIngredient(1,"Barrel_Blue");
		InsertIngredient(1,"Barrel_Red");
		InsertIngredient(1,"Barrel_Yellow");
		InsertIngredient(1,"BarrelHoles_Green");
		InsertIngredient(1,"BarrelHoles_Blue");
		InsertIngredient(1,"BarrelHoles_Red");
		InsertIngredient(1,"BarrelHoles_Yellow");
