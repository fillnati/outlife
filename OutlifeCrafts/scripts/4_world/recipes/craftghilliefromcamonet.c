//Made by Pechyvo
class CraftGhillieBushragFromCamonet extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Переробити на Плечову-Гіллі";
...
class CraftGhillieTopFromCamonet extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Переробити на Гіллі-Плащ";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 1.8;//animation length in relative time units
		m_Specialty = 0.01;// value > 0 for roughness, value < 0 for precision
...
class CraftGhillieAttachmentFromCamonet extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Переробити на Гіллі-Обмотку";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 1.8;//animation length in relative time units
		m_Specialty = 0.01;// value > 0 for roughness, value < 0 for precision
...
class CraftGhillieHoodFromCamonet extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Переробити на Гіллі-Капюшон";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 1.8;//animation length in relative time units
		m_Specialty = 0.01;// value > 0 for roughness, value < 0 for precision
...
class CraftGhillieSuitFromCamonet extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Переробити на Маскхалат";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 1.8;//animation length in relative time units
		m_Specialty = 0.01;// value > 0 for roughness, value < 0 for precision
