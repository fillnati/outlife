//Made by Pechyvo
class AddACOGMountForM16A2 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Відкалібрувати Кріплення";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"M16A2");//you can insert multiple ingredients this way
		...
		m_IngredientSetHealth[1] = -25; // -1 = do nothing
		...
		//result1
		AddResult("AD_M16A2");//add results here
