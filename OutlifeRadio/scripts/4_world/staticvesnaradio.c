class Ol_Static_TarasChubay_Vesna extends BuildingSuper
{
protected ref EffectSound Ol_TarasChubaySound;
	
   
    void Ol_Static_TarasChubay_Vesna()
    {
...
class Ol_Static_VV_Vesna extends BuildingSuper
{
protected ref EffectSound Ol_VVSound;
	
   
    void Ol_Static_VV_Vesna()
    {
		if ( GetGame().IsClient()  ||  !GetGame().IsMultiplayer() )
		{		
