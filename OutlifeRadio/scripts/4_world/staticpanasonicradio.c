class Ol_Static_TarasChubay_Panasonic extends BuildingSuper
{
protected ref EffectSound Ol_TarasChubaySound;
	
   
    void Ol_Static_TarasChubay_Panasonic()
    {
...
class Ol_Static_VV_Panasonic extends BuildingSuper
{
protected ref EffectSound Ol_VVSound;
	
   
    void Ol_Static_VV_Panasonic()
    {
		if ( GetGame().IsClient()  ||  !GetGame().IsMultiplayer() )
		{		
